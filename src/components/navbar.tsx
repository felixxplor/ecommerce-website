...
const Navbar = ({ menu, categories, products }: NavBarProps) => {
      ...
      <nav className="sticky z-[100] inset-x-0 top-0 w-full bg-white/75 backdrop-blur-md transition-all">
        <MaxWidthWrapper className="py-3 px-5 xl:px-0">
          <div className="flex items-center justify-between">
            ...
            {/* Show search bar only if not on checkout page */}
            {!isCheckoutPage && <SearchBar />}

            {/* Show navigation menu only if not on checkout page */}
            {!isCheckoutPage && (
                    ...
                    <NavigationMenuContent className="">
                      <div className="mx-auto max-w-screen-xl grid grid-cols-4 gap-5 px-2.5 md:px-20 py-10">
                        ...
                        <div className="flex flex-col col-span-1 w-full h-full">
                          <Link href="/blog/design-ideas" className="block">
                            <div className="w-full h-[200px] relative">
                              <Image
                                alt="Ideas"
                        ...
                        <div className="flex flex-col col-span-1 w-full h-full">
                          <Link href="/blog/lighting-tips" className="block">
                            <div className="w-full h-[200px] relative">
                              <Image
                                alt="Tips"
                                src="/home-intro-2.png"
                                fill
                                className="object-cover"
                              />
                            </div>
            ...
            <div className="flex order-3 lg:order-none">
              {/* Always show user and cart icons, even on checkout page */}
              <UserLink />
              <CartDrawer />
            </div>
          </div>
