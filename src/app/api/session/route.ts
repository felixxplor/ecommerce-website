...
import { GetSessionDocument, GetSessionQuery, Cart, Customer, getClient } from '@/graphql'
...
export async function POST(request: Request) {
  try {
    ...
    const results = await graphQLClient.request<GetSessionQuery>(GetSessionDocument)
