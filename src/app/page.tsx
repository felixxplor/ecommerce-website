          ...
          <div className="relative w-full h-full py-14 text-2xl font-extrabold text-balance leading-normal bg-[#F6F5F2] px-5">
            <MaxWidthWrapper>
              ...
              <p className="py-5 mx-auto text-center font-normal text-[16px] max-w-[700px]">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Id, voluptatum quam aliquam
                odio temporibus earum voluptate, eum reiciendis magnam quidem quo ipsam?
              </p>
              ...
              <div className="flex flex-col md:grid grid-cols-3">
                ...
                <div className="md:col-span-2">
                  <div className="w-full max-h-[550px] aspect-square relative">
                    <Image alt="Collections" src="/home-craft.png" fill className="object-cover" />
                  </div>
                </div>
              </div>
            </MaxWidthWrapper>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  <span className="p-0.5 bg-slate-800 text-white">truly elevated the ambiance</span>{' '}
